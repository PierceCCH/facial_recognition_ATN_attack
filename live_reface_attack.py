...
def main():
    ...
    while True:
        ...
        # Draw attack status information at the top of the frame
        attack_status_text = f"Attack: {'ON' if attack_active else 'OFF'} | Strength: {attack_strength:.1f}"
        cv2.putText(display_frame, attack_status_text, (10, 30), 
        ...
        cv2.putText(display_frame, "A: Toggle attack", (20, y_offset + 40), 
                    cv2.FONT_HERSHEY_SIMPLEX, 0.5, (255, 255, 255), 1)
        cv2.putText(display_frame, "P: Show/hide perturbation", (20, y_offset + 60), 
                    cv2.FONT_HERSHEY_SIMPLEX, 0.5, (255, 255, 255), 1)
        cv2.putText(display_frame, "+/-: Adjust attack strength", (20, y_offset + 80), 
                    cv2.FONT_HERSHEY_SIMPLEX, 0.5, (255, 255, 255), 1)
        cv2.putText(display_frame, "TAB: Switch between faces", (20, y_offset + 100), 
                    cv2.FONT_HERSHEY_SIMPLEX, 0.5, (255, 255, 255), 1)
        cv2.putText(display_frame, "0-3: Change target", (20, y_offset + 120), 
                    cv2.FONT_HERSHEY_SIMPLEX, 0.5, (255, 255, 255), 1)
        ...
        if key == ord('q'):
            ...
            show_perturbation = not show_perturbation
            print(f"Perturbation display {'on' if show_perturbation else 'off'}")
